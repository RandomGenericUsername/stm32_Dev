...
namespace gpioParameters { enum Parameter {port = 0, pin = 1, mode = 2, pupd = 3, oType = 4, oSpeed = 5, state = 6}; }
namespace gpioPort { enum Port{A = 0x0UL, B = 0x01UL, C = 0x02UL, D = 0x03UL, E = 0x04UL, H = 0x07UL, null = -1}; }
namespace gpioPin { enum Pin{_0 = 0UL, _1 = 1UL, _2 = 2UL, _3 = 3UL, _4 = 4UL, _5 = 5UL, _6 = 6UL, _7 = 7UL, _8 = 8UL, _9 = 9UL, _10 = 10UL, _11 = 11UL, _12 = 12UL, _13 = 13UL, _14 = 14UL, _15 = 15UL, null = -1}; }
namespace gpioMode { enum Mode { input = 0x0U, output = 0x1U, alternateFunction = 0x2U, analogInput = 0x3U }; }
namespace gpioPUPD { enum PUPD { disabled = 0x00U, pullUp = 0x01U, pullDown = 0x02U }; }
namespace gpioOutputType { enum OutputType { pushPull = 0x0U, openDrain	= 0x1U }; }
namespace gpioOutputSpeed { enum OutputSpeed { low  = 0x0UL, medium = 0x1UL, fast = 0x2UL, high	= 0x3UL }; }
namespace gpioState { enum State{low = 0, high = 1 }; }
namespace gpioStatus{ enum Status{reset = 0, ready = 1, busy = 2, error = 4}; }
